...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/PerfectlySoft/Perfect-HTTP.git", .exact("3.0.1")),
	...
	targets: [
		.target(name: "Webretail", dependencies: ["SwiftString", "SwiftRandom", "PerfectHTTPServer", "PostgresStORM", "Turnstile", "PerfectSMTP"])
	]
)