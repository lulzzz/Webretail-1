...
import {
    ...
    ProductAttributeValue, Article, ArticleAttributeValue, AttributeValue, ArticleForm, Packaging, Price, Discount
} from './../shared/models';
...
export class DetailComponent implements OnInit, OnDestroy {
    ...
    createTree() {
        const attributesNode = Helpers.newNode(this.product.productName, '[]', 'attributes');
